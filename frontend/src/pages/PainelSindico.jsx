   ...
   return (
      <div className="dashboard-layout">
         ...
         <main className="main-content">
            ...
            {/* Tab Bar */}
            <div style={{ display: 'flex', gap: '4px', padding: '0.75rem 1.5rem', background: 'white', borderBottom: '1px solid #e2e8f0' }}>
               {[{ key: 'geral', label: 'Visão Geral' }, { key: 'equipe', label: 'Equipe Técnica' }].map(tab => (
                  <button
                     key={tab.key}
                  ...
                  {activeTab === 'geral' && (
                     <>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem' }}>
                           <div>
                              <h3 style={{ fontSize: '15px', fontWeight: 700, color: '#0f172a', margin: '0 0 2px' }}>Ocorrências do Condomínio</h3>
                              <p style={{ fontSize: '12px', color: '#94a3b8', margin: 0 }}>Monitoramento em tempo real</p>
                           </div>
                           <button
                              onClick={() => setIsFilterOpen(true)}
                              style={{ display: 'flex', alignItems: 'center', gap: '6px', padding: '0.4rem 0.9rem', background: 'white', border: '1px solid #e2e8f0', borderRadius: '7px', fontSize: '0.8rem', fontWeight: 600, color: '#475569', cursor: 'pointer' }}
                           >
                        ...
                        <div className="ps-kpis-grid" style={{ marginBottom: '1.25rem' }}>
                           {[
                              ...
                              return (
                                 <div key={i} style={{ background: '#fff', borderRadius: '10px', padding: '18px 20px', border: '1px solid #e2e8f0', borderLeft: `4px solid ${k.borderColor}` }}>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
                                       <p style={{ fontSize: '11px', fontWeight: 700, textTransform: 'uppercase', color: '#94a3b8', letterSpacing: '0.07em', margin: 0 }}>{k.label}</p>
                                       <div style={{ width: 28, height: 28, borderRadius: '7px', background: k.iconBg, color: k.iconColor, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                          <k.Icon size={14} />
                                       </div>
                                    </div>
                                    <p style={{ fontSize: '32px', fontWeight: 700, color: '#0f172a', margin: '0 0 6px', lineHeight: 1 }}>{k.value}</p>
                                    <p style={{ fontSize: '12px', color: trendColor, margin: 0, fontWeight: 500 }}>
                                       ...
                                       <tbody>
                                          {recentOccurrences.map(occ => (
                                             <tr key={occ.id}>
                                                ...
                                                <td>
                                                   <span className={`badge-pill ${occ.status === 'Aberta' ? 'badge-red' :
